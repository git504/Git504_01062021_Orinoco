...
function listeCams(cam) {
    const templateElt = document.getElementById("B1")
    const cloneElt = document.importNode(templateElt.content, true)

    documentFragment.getElementsByClassName("Imageproduit").textContent = cam.imageUrl
    document.getElementById("B1").appendChild(cloneElt)
  }
  
/* <div class="Block">
<div class="B1">
    <img src="http://localhost:3000/images/vcam_1.jpg" alt="image du produit" class="Imageproduit">
</div>
<div class="B2">
    <h2 class="Nomproduits">Zurss 50S</h2>
    <p class="Prixproduit">499 euros</p>
    <a href="produit.html?id=5be1ed3f1c9d44000030b061" style="color: rgb(49, 49, 49); font-weight: bold;">En savoir plus ...</a>
</div>
</div>
